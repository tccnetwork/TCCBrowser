...
- [x] Hai bất biến tạm thời KHÔNG VỚI TỚI ĐƯỢC vì ví thu về chỉ-đọc: câu "việc này chuyển tiền" trên hàng ký, và khung đôi B31 ở màn xác nhận giao dịch. Mã và chuỗi vẫn còn, chỉ đường tới là đóng. Ghi vào `SECURITY.md` để người soát không tưởng chúng đang được canh
