...
mod kiem_thu {
    ...
    /// ⚠️ Danh sách này phải ĐỦ MỌI biến thể `TextKey`. Luật 25 trong
    /// `tools/kiem-luat-phu-thuoc.sh` đếm hai bên và đỏ nếu lệch — 27/08/2026
    /// nó bắt được 65 khoá thiếu, tức 65 chuỗi có thể để rỗng hoặc chép
    /// nguyên tiếng Việt sang ô tiếng Anh mà biên dịch qua, phép thử qua.
    const MOI_KHOA: &[TextKey] = &[
        ...
        TextKey::NhapNutChon,
        TextKey::NhapNutHuy,
        TextKey::NhapPinTieuDe,
        TextKey::NhapPinNhan,
        TextKey::NhapPinViSao,
        TextKey::NhapPinChiDungMotLan,
        TextKey::NhapNutMoKhoa,
        TextKey::NhapXongTieuDe,
        TextKey::NhapBanCuVanCon,
        TextKey::NhapBanCuLamGi,
        TextKey::NhapCumTuDaMangSang,
        TextKey::NhapNutXong,
        TextKey::NhapLoiSaiPin,
        TextKey::NhapLoiKhoaCu,
        TextKey::NhapLoiLechDiaChi,
        TextKey::NhapLoiDocKhongDuoc,
        TextKey::CumTuTieuDe,
        TextKey::CumTuNhan,
        TextKey::CumTuGiaiThich,
        TextKey::CumTuAiNhinCungDoc,
        TextKey::CumTuNutTiep,
        TextKey::CumTuXacNhanTieuDe,
        TextKey::CumTuDayLaVi,
        TextKey::CumTuKiemKyTruocKhiCat,
        TextKey::CumTuNutCat,
        TextKey::CumTuLoiKhongHopLe,
        TextKey::HongTieuDe,
        TextKey::HongKhongCatDuoc,
        TextKey::HongNutDong,
        TextKey::CumTuNutSuaLai,
        TextKey::HongChuaKyGoi,
        TextKey::HongKhongPhaiLoiCuaBan,
        TextKey::PhienTieuDe,
        TextKey::PhienKhongCatDau,
        TextKey::PhienDongLaMat,
        TextKey::XongTieuDe,
        TextKey::XongMaGiaoDich,
        TextKey::XongConCho,
        TextKey::XongNutDong,
        TextKey::RaNgoaiTieuDe,
        TextKey::RaNgoaiRoiKhoiTcc,
        TextKey::RaNgoaiKhongConCheChan,
        TextKey::RaNgoaiNutMo,
        TextKey::RaNgoaiNutHuy,
        TextKey::RaNgoaiKhongPhaiWeb,
        TextKey::WebNhanDiaChi,
        TextKey::WebNutDi,
        TextKey::WebKhongGiuGi,
